# GCP Jenkins Terraform Kubernetes Module
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_jenkins"></a> [jenkins](#module\_jenkins) | https://github.com/squareops/terraform-kubernetes-jenkins.git | n/a |
