...
| :-----:                       |         :---                |
| **5.1.0**                     |    **1.23,1.24,1.25,1.26,1.27**           |
| **5.1.3**                     |    **1.23,1.24,1.25,1.26,1.27**           |
...
| <a name="input_namespace"></a> [namespace](#input\_namespace) | Name of the Kubernetes namespace where Jenkins will be deployed. | `string` | `"jenkins"` | no |
